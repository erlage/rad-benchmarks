...
export let benchRun = new class extends CPUBenchmarkPuppeteer {
  ...
  async run(page: Page) {
      await clickElement(page, "pierce/#append");
...
export const benchMoveToTop = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_11]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
      await checkElementExists(page, "pierce/tbody>tr:nth-of-type(1000)>td:nth-of-type(1)");
      await clickElement(page, "pierce/#movetotop");
      await clickElement(page, "pierce/#movetobottom");
  }
  async run(page: Page) {
      await clickElement(page, "pierce/#movetotop");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(2)>td:nth-of-type(1)", "999");
...
export const benchMoveToBottom = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_12]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
...
export const benchAddToTop = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_13]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
  ...
  async run(page: Page) {
      await clickElement(page, "pierce/#addtotop");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(2)>td:nth-of-type(1)", "1001");
  }
}

export const benchAddToBottom = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_14]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
  ...
  async run(page: Page) {
      await clickElement(page, "pierce/#addtobottom");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(999)>td:nth-of-type(1)", "1001");
  }
}

export const benchAdd100ToTop = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_15]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
  ...
  async run(page: Page) {
      await clickElement(page, "pierce/#add100totop");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(2)>td:nth-of-type(1)", "1001");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(101)>td:nth-of-type(1)", "1100");
  }
}

export const benchAdd100ToBottom = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_16]);
  }
  async init(page: Page) {
      await checkElementExists(page, "pierce/#run");
      await clickElement(page, "pierce/#run");
  ...
  async run(page: Page) {
      await clickElement(page, "pierce/#add100tobottom");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(999)>td:nth-of-type(1)", "1001");
      await checkElementContainsText(page, "pierce/tbody>tr:nth-of-type(1098)>td:nth-of-type(1)", "1100");
  }
}
...
export const benchPrependToManyRows = new class extends CPUBenchmarkPuppeteer {
  constructor() {
  ...
  async run(page: Page) {
    await clickElement(page, "pierce/#prepend");
    await checkElementExists(page, "pierce/tbody>tr:nth-of-type(2000)>td:nth-of-type(1)");
  }
}
...
export const benchClear = new class extends CPUBenchmarkPuppeteer {
  constructor() {
      super(benchmarksCommon.cpuBenchmarkInfos[benchmarksCommon.BENCHMARK_10]);
  }
  async init(page: Page) {
    await checkElementExists(page, "pierce/#run");
    await clickElement(page, "pierce/#run");
...
export const benchmarks = <Array<TBenchmarkPuppeteer>>[
  benchRun, 
  benchReplaceAll,
  benchUpdate, 
  benchSelect, 
